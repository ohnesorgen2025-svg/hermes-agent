...
def _scan_memory_content(content: str) -> Optional[str]:
    ...
    threat_message = _first_threat_message(content, scope="strict")
    if threat_message is not None:
    ...
    # Check invisible unicode after text threat scanning so the message stays
    # consistent with the legacy memory-tool contract for these characters.
