...
_HERMES_CORE_TOOLS = [
    ...
    "ha_automation_manage", "ha_dashboard_manage", "ha_supervisor_manage", "ha_update_manage", "ha_admin_diagnose", "ha_integration_manage",
