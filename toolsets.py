...
_HERMES_CORE_TOOLS = [
    ...
    "ha_automation_manage", "ha_dashboard_manage", "ha_supervisor_manage", "ha_update_manage", "ha_admin_diagnose",
    "ha_config_read", "ha_config_write", "ha_config_reload", "ha_integration_manage",
